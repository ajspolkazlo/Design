...
export default function NotFound() {
  return (
    <div className="relative mx-auto max-w-sm pt-28 text-center">
      ...
      <Link
        href="/"
        className="mt-4 inline-block glossy rounded-full bg-accent px-4 py-2 font-semibold text-white transition-colors duration-200 hover:bg-accent-orange dark:text-black"
      >
        Back home
      </Link>
    </div>
